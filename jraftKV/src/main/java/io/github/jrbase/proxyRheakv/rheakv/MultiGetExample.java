...
public class MultiGetExample {
    ...
    public static void multiGet(final RheaKVStore backendProxy) {
        ...
        // async multiGet
        final CompletableFuture<Map<ByteArray, byte[]>> f1 = backendProxy.multiGet(keys);
        final CompletableFuture<Map<ByteArray, byte[]>> f2 = backendProxy.multiGet(keys, false);
        ...
        // async multiGet
        final Map<ByteArray, byte[]> map1 = backendProxy.bMultiGet(keys);
        Map<ByteArray, byte[]> map2 = backendProxy.bMultiGet(keys, false);
