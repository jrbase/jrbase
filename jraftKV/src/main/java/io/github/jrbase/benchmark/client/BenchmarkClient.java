 ...
 */
package io.github.jrbase.benchmark.client;
...
import io.github.jrbase.benchmark.Yaml;
...
public class BenchmarkClient {
    ...
    public static void main(final String[] args) {
        ...
        backendProxy.bPut("io/github/jrbase/benchmark", BytesUtil.writeUtf8("io.github.jrbase.benchmark start at: " + new Date()));
        LOG.info(BytesUtil.readUtf8(backendProxy.bGet("io/github/jrbase/benchmark")));

        ConsoleReporter.forRegistry(KVMetrics.metricRegistry()) //
                .build() //
                .start(30, TimeUnit.SECONDS);

        LOG.info("Start io.github.jrbase.benchmark...");
