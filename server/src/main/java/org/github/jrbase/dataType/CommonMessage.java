...
public class CommonMessage {
    ...
    public final static String REDIS_LIST_DELIMITER = ",";
    public final static String REDIS_EMPTY_LIST = "+(empty list or set)\r\n";
    public final static String REDIS_EMPTY_SET = "+(empty list or set)\r\n";
